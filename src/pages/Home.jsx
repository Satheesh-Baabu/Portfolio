      ...
      <div className='bg-gradient-to-r from-cyan-950 to-gray-800 w-full md:h-max overflow-hidden'>
        ...
        <div className='pt-24 px-10 h-fit flex flex-col md:flex-row place-items-center space-evenly'>
          <div className=' basis-3/4'>
            ...
            <p className='text-white mt-9 md:text-lg'>Crafting seamless digital experiences as a Web Developer, Mobile App Developer and UI/UX Designer - bringing ideas to life with innovation and precision.</p> 
